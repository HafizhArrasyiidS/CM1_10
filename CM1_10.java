...
public class CM1_10 {
    public static void main(String[] args) {
        ...
        double rataRata = (nilaiAkhir1 + nilaiAkhir2) / 2;
            ...
            if (nilaiAkhir1 >= 80) predikat1 = "A";
            else if (nilaiAkhir1 >= 73) predikat1 = "B+";
            else if (nilaiAkhir1 >= 65) predikat1 = "B";
            else if (nilaiAkhir1 >= 60) predikat1 = "C+";
            else if (nilaiAkhir1 >= 50) predikat1 = "C";
            else if (nilaiAkhir1 >= 39) predikat1 = "D";
            else predikat1 = "E";

            if (nilaiAkhir2 >= 80) predikat2 = "A";
            else if (nilaiAkhir2 >= 73) predikat2 = "B+";
            else if (nilaiAkhir2 >= 65) predikat2 = "B";
            else if (nilaiAkhir2 >= 60) predikat2 = "C+";
            else if (nilaiAkhir2 >= 50) predikat2 = "C";
            else if (nilaiAkhir2 >= 39) predikat2 = "D";
            else predikat2 = "E";
